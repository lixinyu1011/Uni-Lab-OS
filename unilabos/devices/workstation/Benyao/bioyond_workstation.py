...
from unilabos.devices.workstation.bioyond_material_management import BioyondMaterialManagement
from unilabos.ros.nodes.resource_tracker import DeviceNodeResourceTracker
from unilabos.utils.log import logger
from pylabrobot.resources.deck import Deck
from unilabos.resources.graphio import resource_bioyond_to_ulab, resource_ulab_to_plr, resource_bioyond_container_to_ulab
...
class BioyondWorkstation(WorkstationBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # 初始化物料管理模块
        self.material_management = self._create_material_management_module()
    ...
    def _create_material_management_module(self) -> BioyondMaterialManagement:
        ...
        # 如果resource_tracker不存在，创建一个简单的模拟对象
        if resource_tracker is None:
            from unilabos.ros.nodes.resource_tracker import DeviceNodeResourceTracker
            resource_tracker = DeviceNodeResourceTracker()
        
        return BioyondMaterialManagement(
            device_id=device_id,
